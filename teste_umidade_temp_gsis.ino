...
const char* ssid = "WIFI_Mobile";                 //SSID da rede WIFI
...
const char* mqttTopicSub ="altieres_teste/hello_world";            //tópico que sera assinado
...
void enviaDHT(){
  ...
  else 
  {
    ...
    client.publish("altieres_teste/umidade", MsgUmidadeMQTT);
    sprintf(MsgTemperaturaMQTT,"%f",temperatura);
    client.publish("altieres_teste/temperatura", MsgTemperaturaMQTT);
  }
}
